...
const navigation = [
  ...
  const teams = [
    { id: 1, name: 'SAMSUNG', href: '#', initial: 'L', current: false },
  ...
  const orders = [
    {
      ...
      deliveredDate: 'October 12, 2023',
      deliveredDatetime: '2021-07-12',
      total: 'PP600.00',
      products: [
        {
          id: 1,
          name: 'Galaxy Tab A8 10.5” 64GB ',
          description:
            'Experience the perfect blend of performance, portability, and immersive entertainment with the SAMSUNG Galaxy Tab A8. This sleek and stylish tablet is designed to enhance your digital lifestyle and redefine your on-the-go experience.',
          href: '#',
          price: 'PP600',
          imageSrc: '/a8.jpg',
          imageAlt:
          ...
          <div className="xl:pr-96">
            <div className="px-4 py-10 sm:px-6 lg:px-8 lg:py-6">
                ...
                <div className="flex">
                    ...
                    <div>
                        <h2 className="text-xl font-bold">Premio Points</h2>
      ...
      <div className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl sm:px-2 lg:px-8">
          <div className="mx-auto max-w-2xl px-4 lg:max-w-4xl lg:px-0">
            <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Eligible Rewards from followed brands</h1>
            <p className="mt-2 text-sm text-gray-500">
            Discover exciting ways to redeem your points for exclusive rewards and benefits that enhance your experience.
            </p>
          </div>
        </div>
                ...
                >
                  ...
                  <div className="flex items-center border-b border-gray-200 p-4 sm:grid sm:grid-cols-4 sm:gap-x-6 sm:p-6">
                    <dl className="grid flex-1 grid-cols-2 gap-x-6 text-sm sm:col-span-3 sm:grid-cols-3 lg:col-span-2">
                      <div>
                        <dt className="font-medium text-gray-900">Lemnos</dt>
                        <dd className="mt-1 text-gray-500">{order.number}</dd>
                      </div>
                      <div className="hidden sm:block">
                        <dt className="font-medium text-gray-900">Overall validity</dt>
                        ...
                        <div className="mt-6 sm:flex sm:justify-between">
                          <div className="flex items-center">
                            ...
                            <p className="ml-2 text-sm font-medium text-gray-500">
                              Eligible until <time dateTime={order.deliveredDatetime}>{order.deliveredDate}</time>
                            </p>
                          </div>
